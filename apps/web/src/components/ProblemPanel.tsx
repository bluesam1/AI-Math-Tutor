...
const ProblemPanel: React.FC<ProblemPanelProps> = ({ problem, problemType }) => {
  if (!problem) {
    return (
  ...
  const badge = problemType && problemTypeBadges[problemType as ProblemType]
    ? problemTypeBadges[problemType as ProblemType]
    : problemTypeBadges.word;

  return (
    <div className="flex h-full flex-col bg-background-secondary p-6 lg:p-8" role="region" aria-label="Problem display">
      <div className="mb-6">
